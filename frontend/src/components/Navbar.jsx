            ...
            {guestLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.path}
                  to={link.path}
                  className={`px-3 py-2 text-xs font-bold rounded-xl transition-all duration-200 transform hover:scale-[1.03] active:scale-95 ${isActive
                    ...
                    {notifications.length === 0 ? (
                      ...
                      notifications.map((n) => (
                        <div
                          ...
                          className={`py-3 flex items-start gap-2.5 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-950/20 px-1.5 rounded-lg transition-colors ${!n.is_read ? 'bg-brand-50/10 dark:bg-brand-950/5' : ''
                            }`}
                        >
